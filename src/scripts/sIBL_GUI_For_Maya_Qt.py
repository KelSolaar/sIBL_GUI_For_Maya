...
def openPreferences():
	...
	cmds.separator(height = separatorHeight, style = "none")
	...
	cmds.rowLayout("executablePathRowLayout", numberOfColumns = 2, adjustableColumn = 1, columnAlign2 = ["center", "center"], columnAttach = [(1, "both", horizontalSpacing), (2, "both", horizontalSpacing)])
